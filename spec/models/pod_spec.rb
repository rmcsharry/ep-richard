  ...
  describe "logs visits" do
    ...
    context "with 2 parents" do
      ...
      it "returns parentA with 1 visit and parentB did not visit" do
        ...
        expect(pod.parents_who_did_not_visit("last_week")).to eq "We haven't seen <strong>Basil Safwat</strong> lately.\n      Could you keep an eye out for them at drop off, pick up, or stay and play?"
         expect(pod.parents_who_did_not_visit("all_time")).to eq "We haven't seen <strong>Basil Safwat</strong> lately.\n      Could you keep an eye out for them at drop off, pick up, or stay and play?"
      end
      ...
      it "returns 2 parents with 1 visit each and non-visitors is empty" do
        ...
        expect(pod.parents_who_visited("all_time")).to eq({ parentA.id => 1, parentB.id => 1 })
          expect(pod.parents_who_did_not_visit("last_week")).to eq "Awesome! Your parents are super-engaged, keep it up! Share the good news with members of your team!"

        expect(pod.parents_who_did_not_visit("all_time")).to eq "Awesome! Your parents are super-engaged, keep it up! Share the good news with members of your team!"
